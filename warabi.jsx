...
(function() {
  var border, createAlpha, findOrCreateAlphaChannel, find_targets, main, selectTransparentArea, setup, sort, targetLayerSet;
  ...
  sort = function() {
    ...
    for (j = 0, len1 = targets.length; j < len1; j++) {
      target = targets[j];
      results.push(target.layer.translate(UnitValue(target.coords.x, 'px') - target.x, UnitValue(target.coords.y, 'px') - target.y));
    }
    return results;
  };
