...
(function() {
  var createAlpha, main, selectTransparentArea, setup, sort, targetLayerSet;
  ...
  sort = function() {
    var block, blocks, border, coords, fix, i, j, layer, len, len1, original, packer, ref, results, targets;
    ...
    for (j = 0, len1 = blocks.length; j < len1; j++) {
      ...
      results.push(block.layer.translate(fix[0] - original[0], fix[1] - original[1]));
    }
    return results;
  };

  createAlpha = function() {
    var channel, copy, i, len, mergedLayer, ref, targetAlphaChannel;
